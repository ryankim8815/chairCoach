...
const KAKAO_AUTH_URL = `kauth.kakao.com/oauth/authorize?client_id=338d7dc2b4538c92f43109046a6093ec&redirect_uri=https://kdt-ai5-team04.elicecoding.com/login/oauth2/code/kakao&response_type=code`;
