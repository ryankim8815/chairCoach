      ...
      <div className='inner'>
        <TopCon>
          ...
          <form onSubmit={handleSubmit}>
              <F.InputText type="text" value={email} placeholder='이메일' onChange={e => setEmail(e.target.value)} />
              <F.InputText type="password" value={password} placeholder='비밀번호' onChange={e=> setPassword(e.target.value)} />
