    ...
    <S.ResultContainer>
      ...
      <S.ResultBox>
        <S.HalfBox>
          <S.TextBox>
            <S.SubTitle>
              설문 조항 결과에 따르면, name님의 거북목 위험도는 <S.Percent>{point * 10}%</S.Percent>
              입니다!
            </S.SubTitle>
          </S.TextBox>
        </S.HalfBox>
      ...
      <S.RecommendBox>
        <S.SubTitle><S.BoldLetter>CHAIR COACH</S.BoldLetter>의 <S.BoldLetter>정밀진단</S.BoldLetter>을 받아볼까요?</S.SubTitle>
        <S.BtnBox>
      <RecommendButton onClick={()=>{
        navigate('/chaircoach')
      }} size='small' check='false'>네</RecommendButton>
      <RecommendButton onClick={()=>{
        navigate('/')
      }}  size='small' check='false'>아니오</RecommendButton>
      </S.BtnBox>
      </S.RecommendBox>
