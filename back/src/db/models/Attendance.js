...
var Attendance = /** @class */ (function () {
    ...
    // atnd_id로 검색
    Attendance.findByAtndId = function (_a) {
        var atnd_id = _a.atnd_id;
    ...
    // user_id로 검색
    Attendance.findByUserId = function (_a) {
    ...
    // 등록일로 검색
    Attendance.findByCreatedAtDate = function (_a) {
    ...
    // 등록
    Attendance.create = function (_a) {
        var atnd_id = _a.atnd_id, user_id = _a.user_id, created_at = _a.created_at;
        return __awaiter(this, void 0, void 0, function () {
            var _b, rows, fields;
            return __generator(this, function (_c) {
                switch (_c.label) {
